...
def generate(
    ...
    **kwargs,
    ...
    """Registry entry point: the SafeFlow CBF filter against a Constraint.

    A control barrier function is defined by an inequality, so this baseline
    handles inequalities only.
    """
